      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
        <div className="flex items-center justify-between border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10">
          <div className="flex justify-start lg:w-0 lg:flex-1">
            <Link to="/">
              <span className="sr-only">DAKHKO</span>
            <h4 className="text-blue-900 text-4xl truncate ">DAKHKO</h4>
            </Link>
          </div>
            ...
            <Popover className="relative">
              {({ open }) => (
                <>
                  ...
                  >
                    <span className="text-2xl">MEER</span>
                    <ChevronDownIcon
                      className={classNames(
                      ...
                      <div className="overflow-hidden rounded-lg shadow-lg ring-1 ring-black ring-opacity-5">
                        <div className="relative grid gap-6 bg-white px-5 py-6 sm:gap-8 sm:p-8">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 text-indigo-500">
                              ...
                              <div className="ml-4">
                                <p className="text-base font-medium text-gray-900"> Contacteer ons </p>
              ...
              <div className="mt-6">
                <nav  className="grid gap-y-8">
                    ...
                    <Link onClick={() => handFeedback()} to="/" className="-m-3 flex items-center rounded-md p-3 hover:bg-gray-50">
                      ...
                      <span className="ml-3 text-base font-medium text-gray-900"> Contacteer ons </span>
                    </Link>
                    ...
                    <a href="#fotosVanJob" className="-m-3 flex items-center rounded-md p-3 hover:bg-gray-50">
                         ...
                         <span className="ml-3 text-base font-medium text-gray-900"> VOOR-EN-NA-FOTO'S </span>
                    </a>
