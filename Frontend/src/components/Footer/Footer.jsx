...
<footer className="bg-black dark:bg-gray-900">
    <div className="grid grid-cols-2 gap-8 py-8 px-6 md:grid-cols-4 md:flex md:items-center md:justify-around">
        ...
        <div>
            ...
            <ul className="text-gray-500 dark:text-gray-400 text-center">
                ...
                <li className="mb-4">
                    <Link to="/" className="hover:underline">Bestel een telefoontje van ons</Link>
                </li>
            </ul>
        </div>
        {/* <div className='mr-10'>
    ...
    <div className="bg-black py-6 px-4 bg-gray-900 dark:bg-gray-700 md:flex md:items-center md:justify-between">
        <span className="text-sm text-gray-500 dark:text-gray-300 sm:text-center">© 2022 <a href="https://flowbite.com/">Taism™</a>. Web Development.
        </span>
        <div className="flex mt-4 space-x-6 sm:justify-center md:mt-0">
            <a href="https://www.facebook.com/profile.php?id=100073289193117" target="_blank" rel="noreferrer"  className="text-gray-400 hover:text-gray-900 dark:hover:text-white">
            ...
            <a href="https://www.instagram.com/taismdg/" target="_blank" rel="noreferrer" className="text-gray-400 hover:text-gray-900 dark:hover:text-white">
            ...
            <a href="https://github.com/TaismDG" target="_blank" rel="noreferrer" className="text-gray-400 hover:text-gray-900 dark:hover:text-white">
